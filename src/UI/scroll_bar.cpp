...
namespace Scroll_Bar {
  ...
  bool Update_ScrollBar(App::App &app) {
    ...
    if (app.selected == Mouse::SCROLLBAR_LEFT) {
    ...
    else if (app.selected == Mouse::SCROLLBAR_RIGHT) {
    ...
    else if (app.selected == Mouse::SCROLLBAR_FIXTURES) {
  ...
  bool Update_Expander(App::App &app) {
    if (app.selected == Mouse::EXPANDER_LEFT) {
    ...
    else if (app.selected == Mouse::EXPANDER_RIGHT) {
    ...
    else if (app.selected == Mouse::EXPANDER_FIXTURES) {
